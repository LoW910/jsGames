    ...
    for (var i = 0, len = squares.length; i < len; i++)
            ...
            squares[i].onclick = function(){
                ...
                if(squares[index + 7].classList.contains('taken') && !squares[index].classList.contains('taken')){
                    if(currentPlayer === 1) {
                        ...
                        alert(`Can't get there from here.. Try again.`)
                    }
            }
        })(i)
        ...
        function checkBoard() {
            ...
            for(let y = 0; y < winningArrays.length; y++) {
                ...
                // now check those arrays to see if they all have the class of playerOne
                ...
                square4.classList.contains('playerOne')){
                    //if they do, playerOne is passed as the winner
                ...
                square4.classList.contains('playerTwo')) {
                    // if they do, playerTwo is passed as the winner
                    result.innerHTML = "Player Two Wins!";
                }
            }
    
        }
        // add an addEventListener to each square that will trigger the checkBoard function on click
